...
export default function ReferralRewardCard(props: {
  avatarURL: string;
  title: string;
  amount: number;
}) {
      ...
      <div className="w-full h-full inline-flex gap-1 items-center justify-between">
        <div className="w-full max-w-32 h-full flex flex-col items-start justify-start">
          ...
          <div className="w-full h-full inline-flex items-end justify-start">
            <p className="text-base leading-5 text-foreground font-medium text-normal-stroke">
              {props.title}
            </p>
          </div>
        </div>
        <div className="h-full inline-flex items-end justify-end">
          <p className="text-base leading-5 text-gold font-medium text-end inline-flex gap-2 items-center align-middle">
