...
export async function getUserTelegramId(
  ...
  const { data, error } = await client.from('users').select().eq('id_tg', tgId);
...
// Get ranks data
export async function getRanks(client: SupabaseClient<Database, 'public'>) {
  const { data, error } = await client
    .from('ranks')
    .select()
...
export async function updateUserStats(
  ...
  const { error } = await client.from('users').update(user).eq('id', user.id);
...
export async function addPlayerAndReferral(
  ...
  const { error: errorReferrals } = await client.from('Referrals').insert({
...
export async function getLevelsPlayer(
  ...
  const { data, error } = await client.from('Levels_Player').select();
...
export async function getMines(client: SupabaseClient<Database, 'public'>) {
...
export async function getLevelsMine(
  ...
  const { data, error } = await client.from('Levels_Mine').select();
